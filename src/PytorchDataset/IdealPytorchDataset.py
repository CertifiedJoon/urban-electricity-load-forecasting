...
class IdealPytorchDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        target_seq = values[-prediction_shift:]
        ...
        return {
            ...
            'end_ts': window_plus_one.index[-prediction_shift-1].timestamp() # End of input window
        }
    ...
    def get_full_home_stream(self, home_id):
        ...
        full_power_tensor = torch.tensor(target_sample['dynamic']['value'].values, dtype=torch.float32).unsqueeze(-1)
